    ...
    <div className="min-h-screen bg-amber-50 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-amber-700 tracking-widest uppercase mt-1">
            Luxury RV Glamping · Folsom Lake
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-amber-100 p-8">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-stone-500 text-sm mt-1">
              Sign in to manage your glamping experiences
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border border-stone-200 hover:border-stone-300 hover:bg-stone-50 text-stone-800 font-medium py-3 px-4 rounded-xl transition-all duration-200 shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
            >
            ...
            >
              {loadingProvider === 'facebook' ? (
                <span className="w-5 h-5 border-2 border-stone-300 border-t-[#1877F2] rounded-full animate-spin" />
              ) : (
            ...
            <button
              ...
              disabled={loadingProvider !== null}
              className="w-full flex items-center justify-center gap-3 bg-stone-900 hover:bg-stone-800 text-white font-medium py-3 px-4 rounded-xl transition-all duration-200 shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loadingProvider === 'apple' ? (
                <span className="w-5 h-5 border-2 border-stone-600 border-t-white rounded-full animate-spin" />
              ) : (
        ...
        <div className="text-center mt-6">
          <Link
            href="/"
            className="text-stone-500 hover:text-amber-700 text-sm transition-colors duration-200"
          >
            ← Back to Home
          </Link>
        </div>
